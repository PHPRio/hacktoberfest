...
**LSTelegramNotify** | LimeSurvey Plugin to send AfterSurveyComplete notification to Telegram  | [https://github.com/LibreCodeCoop/LSTelegramNotify](https://github.com/LibreCodeCoop/LSTelegramNotify)
...
**Távola** | Um app para realização de assembleias online no Nextcloud |[https://github.com/LibreCodeCoop/tavola](https://github.com/LibreCodeCoop/tavola)
**WebDsv** | Web Digital Signature Validator, página para validação de assinaturas digitais padrão ICP em documentos PDF |[https://github.com/LibreCodeCoop/webdsv](https://github.com/LibreCodeCoop/webdsv)
**WhatsApp Client** | Um cliente para o WhatsApp Web feito em PHP  |[https://github.com/LibreCodeCoop/whatsapp-client](https://github.com/LibreCodeCoop/whatsapp-client)
